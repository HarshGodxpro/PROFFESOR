...
✯ 𝙱𝚄𝙸𝙻𝙳 𝚂𝚃𝙰𝚃𝚄𝚂: v2.0.1 [ 𝙱𝙴𝚃𝙰 ]</b>"""
    ...
    SOURCE_TXT = """<b>NOTE:</b>
<b>- ᴘʀᴏꜰꜰᴇꜱᴏʀ 𝙸𝚂 𝙾𝙿𝙴𝙽 𝚂𝙾𝚄𝚁𝙲𝙴 𝙿𝚁𝙾𝙹𝙴𝙲𝚃. 
- 𝚂𝙾𝚄𝚁𝙲𝙴 - 𝙲𝙻𝙸𝙲𝙺 𝚁𝙴𝙿𝙾 𝙱𝚄𝚃𝚃𝙾𝙽</b>
<b>DEVS:</b>
- <a href=https://t.me/avtar_the_wayofwater>ᴍᴏᴠɪᴇʟᴀɴᴅ.ᴄᴏᴍ</a>"""
...
<b>NOTE:</b>
<b>𝟷. ᴘʀᴏꜰꜰᴇꜱᴏʀ 𝚂𝙷𝙾𝚄𝙻𝙳 𝙷𝙰𝚅𝙴 𝙰𝙳𝙼𝙸𝙽 𝙿𝚁𝙸𝚅𝙸𝙻𝙻𝙰𝙶𝙴.
...
<b>ᴘʀᴏꜰꜰᴇꜱᴏʀ 𝚂𝚄𝙿𝙿𝙾𝚁𝚃𝚂 𝙱𝙾𝚃𝙷 𝚄𝚁𝙻 𝙰𝙽𝙳 𝙰𝙻𝙴𝚁𝚃 𝙸𝙽𝙻𝙸𝙽𝙴 𝙱𝚄𝚃𝚃𝙾𝙽𝚂.</b>
<b>NOTE:</b>
...
<b>COMMAND</b> : /font your text (optional)
 ...
 <i>This feature added by @ᴍᴏᴠɪᴇʟᴀɴᴅ.ᴄᴏᴍ"""
    JSON_TXT = """<b>JSON:</b>
